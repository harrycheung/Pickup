...
export const Actions = {
  ...
  addStudent: (firstName: string, lastInitial: string, imageURL: string, grade: string, admin: bool) => ({
    type: Types.ADD_STUDENT, firstName, lastInitial, image: imageURL, grade, admin,
  }),
